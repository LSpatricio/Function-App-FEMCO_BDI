...
namespace FUNCTION_FEMCO_BDI.Table.Custom.CONFIGPUESTOFUNCION
{
    public class Function_CONFIGPUESTOFUNCION
    {
        ...
        {
            _logger = loggerFactory.CreateLogger<Function_CONFIGPUESTOFUNCION>();
            _dao = dao;
        ...
        public async Task<string> BulkCreate_CONFIGPUESTOFUNCION()
        {
            string modeloICM = Environment.GetEnvironmentVariable("ModelFemcoVS");
            string TablaICM = "ConfigPuestoFuncion";
        ...
        [Function("BulkCreate_Trigger_CONFIGPUESTOFUNCION")]
        public async Task<HttpResponseData> BulkCreate_Trigger_CONFIGPUESTOFUNCION([HttpTrigger(AuthorizationLevel.Function, "post", Route = "BulkCreate_Trigger_CONFIGPUESTOFUNCION")] HttpRequestData req)
        {
            _logger.LogInformation("Inicio de la función BulkCreate_Trigger_CONFIGPUESTOFUNCION.");
            ...
            try
            {
                string mensaje = await BulkCreate_CONFIGPUESTOFUNCION();
            ...
            {
                _logger.LogInformation("Fin de la función BulkCreate_Trigger_CONFIGPUESTOFUNCION");
        ...
        public async Task BulkCreate_Timer_CONFIGPUESTOFUNCION([TimerTrigger("0 50 16 9 12 *")] TimerInfo myTimer)
        {
            ...
            {
                _logger.LogError(ex, "Error al ejecutar la función BulkCreate_Timer_CONFIGPUESTOFUNCION: {Message}", ex.Message);
            }
            finally
            {
                _logger.LogInformation("Fin de la función BulkCreate_Timer_CONFIGPUESTOFUNCION.");
            }
        }
