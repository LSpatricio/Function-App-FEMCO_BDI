...
namespace FUNCTION_FEMCO_BDI.Table.Custom.CATPOSITION
{
    public class Function_CATPOSITION
    {
        private readonly ILogger _logger;
        private readonly DAO_SQL _dao;
        private readonly ICMService _icmservice;
        private const string NOMBRE_TABLA = "FEMCOEPSAP.CATPOSITION";

        public Function_CATPOSITION(ILoggerFactory loggerFactory, DAO_SQL dao, ICMService icmService)
        {
            _logger = loggerFactory.CreateLogger<Function_CATPOSITION>();
            _dao = dao;
        ...
        [Function("BulkCreate_Trigger_CATPOSITION")]
        public async Task<HttpResponseData> BulkCreate_Trigger_CATPOSITION([HttpTrigger(AuthorizationLevel.Function, "post", Route = "BulkCreate_Trigger_CATPOSITION")] HttpRequestData req)
        {
            _logger.LogInformation("Inicio de la función BulkCreate_Trigger_CATPOSITION.");
            ...
            {
                _logger.LogInformation("Fin de la función BulkCreate_Trigger_CATPOSITION");
        ...
        public async Task BulkCreate_Timer_CATPOSITION([TimerTrigger("0 0 5 * * *")] TimerInfo myTimer)
        {
